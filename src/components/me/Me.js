      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            התחלתי את הדרך שלי בתחום עוד בילדות - הייתי עושה לק ג'ל לכל הילדות בשכונה, הרגשתי שזה הייעוד שלי לכל חיים - נכנסתי לתחום בסערה ועברתי 3 קורסים כושלים אחד אחרי השני!!! משהו שגרם לי להכנס לתחום ולצאת ממנו - הרגשתי שאני עדיין לא מספיק טובה ושיש עוד אלפים כמוני
          </p>
          <p className={styles.description}>
